...
object Constants {
    ...
    const val TITLE_IS_REQUIRED: String = "Title is required"
    const val DESCRIPTION_IS_REQUIRED: String = "Description is required"
    const val SOMETHING_WENT_WRONG: String = "Something went wrong"
    const val ASSIGNER_IS_REQUIRED: String = "Assigner is required"
    const val ASSIGNEE_IS_REQUIRED: String = "Assignee is required"
    const val STATUS_IS_REQUIRED: String = "Status is required"
    const val PRIORITY_IS_REQUIRED: String = "Priority is required"
    const val WORK_TYPE_IS_REQUIRED: String = "Work type is required"
    const val ADD_ATTACHMENTS: String = "Add Attachments"
    const val ADD_ONE_IMAGE_AT_A_TIME: String = "Add one image at a time"
